	...
	var langPack_EN = {	//Guest
						...
						appointmentComplete : "Your appointment has succesfully submitted!", 
    ...
    {		
		...
		if (document.forms[0]){
			...
			var fields = $('#'+formId+' input[type=text],#'+formId+' input[type=password],#'+formId+' input[type=submit],#'+formId+' input[type=button],#'+formId+' textarea ');			
