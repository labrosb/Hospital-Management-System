...
var msgBoxImagePath = "styles/images/msgBox/";				//Default path for main page messages

////Module modification
var loc = window.location.pathname.split('/');
var dirDepth = loc.length;
if (dirDepth == 5){
	var msgBoxImagePath = "../../styles/images/msgBox/"; 	//Path for calendars
}
...
function msg (options) {
    ...
    if (options.type != null) {
        switch (options.type) {
            ...
            case "prompt":
                ...
                break;
            case "custom":
                options.title = options.title == null ? "Choice" : options.title;
    ...
    if (options.type == "prompt") {
        ...
        divMsgBoxImage.remove();
        divMsgBoxButtons.css({"text-align":"center","position":"absolute","top":"100px", "left":"0","right":"0","margin":"auto","margin-top":"-5px"});
		$("#"+divMsgBoxButtonsId+" input" ).css({"margin-left":"8px"});
	}	
    else {
        $("html").append(divBackGround + "<div id=" + divMsgBoxId + " class=\"msgBox\">" + divTitle + "<div>" + divContainer + (options.showButtons ? divButtons + "</div>" : "</div>") + "</div>");
        divMsgBox= $("#"+divMsgBoxId); 
